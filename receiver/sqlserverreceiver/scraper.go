	...
	for i, row := range rows {
		...
		case bytesReceivedFromReplicaPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverReplicaDataRateDataPoint(now, val, metadata.AttributeReplicaDirectionReceived)
			}
		case bytesSentForReplicaPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverReplicaDataRateDataPoint(now, val, metadata.AttributeReplicaDirectionSent)
			}
		...
		case freeListStalls:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverPageFreeListStallsRateDataPoint(now, val)
			}
